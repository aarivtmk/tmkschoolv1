"""
Django settings for tmkblog project.
...
SECRET_KEY = 'django-insecure-#anz(#kw0l3#uuhjl1)460^^9o&lygbc!ui2(rpug@xb=lh!b='
...
WSGI_APPLICATION = 'tmkblog.wsgi.application'
